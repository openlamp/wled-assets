...
[Paletas](palettes.md) · [Efectos](effects.md) · [Controles](controls.md) · [Luz nocturna](nightlight.md) · **Segmento** · [Botones](buttons.md) · [Eventos de botón](button-events.md) · [Presets](presets.md) · [Deslizadores](fxdata.md) · [Campos de info](info.md) · [Etiquetas de IU](ui.md) &nbsp;•&nbsp; [Referencia en español](README.md)
...
Las **acciones de segmento** son opciones por segmento en la pestaña **Segmentos**: invertir, espejo, congelar, on/off, transición, simulación de audio (`seg.rev/mi/frz/on`…).
