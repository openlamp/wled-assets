...
| WLED名 | 翻訳 | 説明 |
|---|---|---|
| `Push` | プッシュ | 物理ボタン/入力の配線方式。 |
| `Push inverted` | プッシュ(反転) | 物理ボタン/入力の配線方式。 |
| `Switch` | スイッチ | 物理ボタン/入力の配線方式。 |
| `PIR sensor` | PIRセンサー | 物理ボタン/入力の配線方式。 |
| `Touch` | タッチ | 物理ボタン/入力の配線方式。 |
| `Analog` | アナログ | 物理ボタン/入力の配線方式。 |
