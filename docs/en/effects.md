...
| <img src="../../images/effects/fill-noise.gif" width="64"> | `Fill Noise` | Fill Noise | Random sparkles pop. |
...
| <img src="../../images/effects/solid-pattern.gif" width="64"> | `Solid Pattern` | Solid Pattern | A pattern of on/off stripes scrolls. |
| <img src="../../images/effects/solid-pattern-tri.gif" width="64"> | `Solid Pattern Tri` | Solid Pattern Tri | A pattern of on/off stripes scrolls. |
...
| <img src="../../images/effects/pixels.gif" width="64"> | `Pixels` | Pixels | Stars twinkle. |
| <img src="../../images/effects/pixelwave.gif" width="64"> | `Pixelwave` | Pixelwave | Ripples spread over water. |
...
| <img src="../../images/effects/noisemeter.gif" width="64"> | `Noisemeter` | Noisemeter | An audio equalizer, bars bouncing to sound. |
| <img src="../../images/effects/freqwave.gif" width="64"> | `Freqwave` | Freqwave | An audio equalizer, bars bouncing to sound. |
| <img src="../../images/effects/freqmatrix.gif" width="64"> | `Freqmatrix` | Freqmatrix | An audio equalizer, bars bouncing to sound. |
| <img src="../../images/effects/geq.gif" width="64"> | `GEQ` | GEQ | An audio equalizer, bars bouncing to sound. |
| <img src="../../images/effects/waterfall.gif" width="64"> | `Waterfall` | Waterfall | Rain falls. |
| <img src="../../images/effects/freqpixels.gif" width="64"> | `Freqpixels` | Freqpixels | An audio equalizer, bars bouncing to sound. |
...
| <img src="../../images/effects/metaballs.gif" width="64"> | `Metaballs` | Metaballs | Colour blobs morph and drift. |
| <img src="../../images/effects/freqmap.gif" width="64"> | `Freqmap` | Freqmap | An audio equalizer, bars bouncing to sound. |
...
| <img src="../../images/effects/shimmer.gif" width="64"> | `Shimmer` | Shimmer | Glitter sparkles over the colour. |
...
| <img src="../../images/effects/plasma-ball.gif" width="64"> | `Plasma Ball` | Plasma Ball | Electric tendrils in a plasma globe. |
| <img src="../../images/effects/flow-stripe.gif" width="64"> | `Flow Stripe` | Flow Stripe | Particles flow across. |
| <img src="../../images/effects/hiphotic.gif" width="64"> | `Hiphotic` | Hiphotic | Colour blobs morph and drift. |
...
| <img src="../../images/effects/ps-attractor.gif" width="64"> | `PS Attractor` | PS Attractor | Rings collapse into a dark core. |
...
| <img src="../../images/effects/ps-spray.gif" width="64"> | `PS Spray` | PS Spray | Particles spray from a nozzle. |
| <img src="../../images/effects/ps-geq-2d.gif" width="64"> | `PS GEQ 2D` | PS GEQ 2D | An audio equalizer, bars bouncing to sound. |
| <img src="../../images/effects/ps-geq-nova.gif" width="64"> | `PS GEQ Nova` | PS GEQ Nova | An audio equalizer, bars bouncing to sound. |
...
| <img src="../../images/effects/ps-spray-1d.gif" width="64"> | `PS Spray 1D` | PS Spray 1D | Particles spray from a nozzle. |
...
| <img src="../../images/effects/ps-starburst.gif" width="64"> | `PS Starburst` | PS Starburst | A firework bursts. |
| <img src="../../images/effects/ps-geq-1d.gif" width="64"> | `PS GEQ 1D` | PS GEQ 1D | An audio equalizer, bars bouncing to sound. |
...
| <img src="../../images/effects/ps-springy.gif" width="64"> | `PS Springy` | PS Springy | A coil spring bounces a bob. |
...
| <img src="../../images/effects/slow-transition.gif" width="64"> | `Slow Transition` | Slow Transition | A colour fades in and out. |
