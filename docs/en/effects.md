...
| <img src="../../images/effects/random-colors.gif" width="64"> | `Random Colors` | Random Colors | Random colour blocks shuffle. |
...
| <img src="../../images/effects/halloween-eyes.gif" width="64"> | `Halloween Eyes` | Halloween Eyes | An eye scans, pupil roving. |
...
| <img src="../../images/effects/blends.gif" width="64"> | `Blends` | Blends | Brightness swells and fades. |
...
| <img src="../../images/effects/drift-rose.gif" width="64"> | `Drift Rose` | Drift Rose | Stars spiral outward. |
...
| <img src="../../images/effects/soap.gif" width="64"> | `Soap` | Soap | Colour blobs morph and drift. |
...
| <img src="../../images/effects/squared-swirl.gif" width="64"> | `Squared Swirl` | Squared Swirl | Stars spiral outward. |
...
| <img src="../../images/effects/sun-radiation.gif" width="64"> | `Sun Radiation` | Sun Radiation | The sun rises. |
| <img src="../../images/effects/colored-bursts.gif" width="64"> | `Colored Bursts` | Colored Bursts | A shockwave ring expands. |
| <img src="../../images/effects/julia.gif" width="64"> | `Julia` | Julia | A colour wave travels along the strip. |
| <img src="../../images/effects/rsvd.gif" width="64"> | `RSVD` | RSVD | A colour wave travels along the strip. |
| <img src="../../images/effects/rsvd.gif" width="64"> | `RSVD` | RSVD | A colour wave travels along the strip. |
| <img src="../../images/effects/rsvd.gif" width="64"> | `RSVD` | RSVD | A colour wave travels along the strip. |
| <img src="../../images/effects/game-of-life.gif" width="64"> | `Game Of Life` | Game Of Life | Code rains down, Matrix-style. |
...
| <img src="../../images/effects/swirl.gif" width="64"> | `Swirl` | Swirl | Stars spiral outward. |
...
| <img src="../../images/effects/ps-vortex.gif" width="64"> | `PS Vortex` | PS Vortex | Stars spiral outward. |
