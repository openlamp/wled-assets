...
|---|---|---|
| `Push` | Poussoir | Comment l'entrée/le bouton physique est câblé. |
| `Push inverted` | Poussoir inversé | Comment l'entrée/le bouton physique est câblé. |
| `Switch` | Interrupteur | Comment l'entrée/le bouton physique est câblé. |
| `PIR sensor` | Capteur PIR | Comment l'entrée/le bouton physique est câblé. |
| `Touch` | Tactile | Comment l'entrée/le bouton physique est câblé. |
| `Analog` | Analogique | Comment l'entrée/le bouton physique est câblé. |
